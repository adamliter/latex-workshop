...
On a new version of Ubuntu, I think you will get TeX Live 2013, for example.
But, that is still two years out of date.
...
Notice in particular that you can give the examples \mintinline{latex}|\label|s and \mintinline{latex}|\ref|er to them inline just like with floats.
