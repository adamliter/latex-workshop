...
\footnote{%
I'm a bit loathe to recommend this because the package currently has a bug, but it's really a great package.
For even a better way of typesetting common linguistic gloss abbreviations than what you see in Listing~\ref{lst:glossed-example}, check out the \href{http://ctan.org/pkg/leipzig}{\Package{leipzig}} package.
...
\begin{listing}[htbp]
	...
	\begin{minted}{latex}
\documentclass{article}
\newcommand*{\Gls}[1]{\textsc{#1}}
\usepackage{gb4e}
\noautomath
\begin{document}
\begin{exe}
    \ex[]{\gll Der Apfel würde gegessen.\\
    The.\Gls{msc}.\Gls{sg}.\Gls{nom} apple was eaten\\
