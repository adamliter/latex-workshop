...
\begin{description}
	...
	\item[\Package{latexmk}]{%
		...
		If you get tired of going through all of the compilation steps necessary for doing a bibliography in \LaTeX{} you might try compiling your document with \href{https://www.ctan.org/pkg/latexmk}{\Package{latexmk}}.%
	}
	...
	\item[Different document classes]{%
		...
		If you want to use \LaTeX{} for presentations, take a look at the \href{https://ctan.org/pkg/beamer}{\Package{beamer}} document class.
