...
\footnote{%
If you're using \hologo{MiKTeX} and you followed the instructions in \S\ref{subsubsec:local-files:miktex} and created your \Directory{texmf} folder inside your Dropbox folder and named it \Directory{Local TeX Files}, then you should read this as referring to \Directory{C:\textbackslash Users\textbackslash <user name>\textbackslash Dropbox\textbackslash Local TeX Files\textbackslash tex\textbackslash latex}.
In other words, I'm just using \Directory{texmf} as a placeholder for wherever you created your local \Directory{texmf} folder.
So this also applies if you created your local \Directory{texmf} folder in Dropbox on OSX or Linux.
That is, you should then put the file inside of \Directory{\textasciitilde/Dropbox/texmf/tex/latex}.%
}
