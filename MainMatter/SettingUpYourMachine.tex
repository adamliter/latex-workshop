...
\footnote{%
I would highly recommend this package, and so this might be another reason why you might wish to consider installing TeX Live over \hologo{MiKTeX} if you're on Windows.
