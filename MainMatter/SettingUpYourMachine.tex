...
For example, this \Directory{texmf} folder is where you would put local style or class files.

The most important use case for the local \Directory{texmf} folder, however, is for maintaining a single master bibliography file that can be used for citations in all of your documents.
